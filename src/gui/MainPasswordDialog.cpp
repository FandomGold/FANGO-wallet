...
{
  m_ui->setupUi(this);
  m_ui->m_version->setText(QString(tr("Fuego Desktop %1")).arg(Settings::instance().getVersion()));
...
{
  QDesktopServices::openUrl(QUrl("https://github.com/fandomgold/guides", QUrl::TolerantMode));
}
